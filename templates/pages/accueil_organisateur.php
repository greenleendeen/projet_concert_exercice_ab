<?php
/*
Template de page complète : affiche la page d’accueil d’un utilisateur- >organisateur

Paramètres:  $organisateur : objet organisateur objet chargé avec ses détails
*/
...
<body class="pageOrganisateur">
    ...
    <h3> page d'accueil Organisateur</h3>
    ...
    <?php
    include "templates/fragments/fragment_detail_organisateur.php";
    ?>
